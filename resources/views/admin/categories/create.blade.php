    ...
    <div class="bg-white shadow-md rounded-lg p-6 border border-gray-100">
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    <button type="submit" class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary-dark transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">Create Category</button>
                </div>
            </div>
        </form>
    </div>
