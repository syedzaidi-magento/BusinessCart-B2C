        ...
        <form method="POST" action="{{ route('admin.products.update', $product) }}">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="short_description" id="short_description" class="w-full p-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 @error('short_description') border-red-500 @enderror">{{ old('short_description', $product->short_description) }}</textarea>
                ...
                <div>
                    ...
                    <input type="checkbox" name="featured" id="featured" value="1" {{ $product->featured ? 'checked' : '' }} class="h-5 w-5 text-primary border-gray-300 rounded focus:ring-primary">
                    @error('featured')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
